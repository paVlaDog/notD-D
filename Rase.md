...
*Иллюзионст от рождения* - Вы можете использовать заклинания дуэргара как способности (БМ раз в день): 
...
*Проворство* - Вы можете удвоить свою скорость до конца хода. В этом ходу, если вы прошли более 40футов перед атакой, то атакуете в ближнем бою с преимуществом.
	Перезарядка - 2 раунда(Т.е. один раунд используется способность, 2 раунда после него - перезарядка.)
	Также, вы можете реакцией совершить перемещение на 10 футов, если к вам подошёл противник(1 раз в раунд).   
...
*Храбрость* - Вы получаете +5 к инициативе. Если вы атакуете первым из своей команда, то ваши союзники воодушевляются и получают +1 к всем атакам, КД и спасброскам до конца боя.  
...
*Целеустремлённые* - Вы можете выбрать черту, к которой стремитесь. При повышении уровня, с шансом 50% вы сразу сможете получить эту черту.(Естественно, потратив очко навыка). Также, вы можете выбрать один дополнительный навык.  
...
*Лёгконогий* - Вы получаете преимущество на проверки уклонения от ловушек. Вы можете реакцией перемещаться на половину своей МС. Сражаясь в лесу, вы можете перемещением устраивать засады(Не более 2 раз в бой).   
...
*Жажда крови* - При убийстве противника вы получаете дополнительное действие и 1к6 временных хитов.  
...
*Вечный изгой* - Вы получаете навык Проницательность. Сражаясь один, вы получаете +1 на все броски атаки.  
*Адское наследие* - Вы получаете БМ случайных Адских заклинаний. Вы можете использовать каждое из них 1 раз в день. Не тратит ячейки заклинаний.  

...
- Вы получаете заклинания Очарование и Фейское целительство. Они не учитываются при подсчёте количества извествестных заклинаний, а также можете использовать их 1 раз в день не тратя ману.
...
- Ваша песнь отдыха даёт союзникам прибавку к КМЗ, равную прибавке к характеристикам.
- Когда ваше вдохновение усиливает атаку заклинанием, оно также увеличивает и урон. Когда ваше вдохновение усиливает проверку навыка, оно также увеличивает КМЗ на следующую атаку по вам.
...
- Вы получаете 2 любых заклинания, воздействующих на разум, с распространённостью не выше "Редкое". Они не учитываются в количестве известных заклинаний.
...
- Вы становитесь полузаклинателем(ИНТ). Вы получаете 1 редкое и 2 необычных заклинания.
- Вы получаете следующие манёвры:
  ...
  - Мистический щит - 2ман, реакция, когда в вас летит магический снаряд, +5 КМЗ на эту защиту.
...
- Вы можете бонусным действие спровоцировать противника. Он проходит средний спас ХАР. При провале он в течении 3 ходов получаете помехи на атаки ваших союзников.
...
- К списку боевых стилей добавляются следующие:
  - Верховая стрельба - +ЛОВ к урону, если вы стреляете верхом.
...
- Вы выбираете одну из следующих способностей, действующих постоянно:
  ...
  - Аура разрушения - сфера, R=25, любое существо в ауре получает -4 к сложности заклинаний разрушения и +3 КМЗ против заклинаний, влетающих в ауру.
...
- Вы получаете -2 к сложности заклинаний возвышения и 3 единицы маны.
...
- Пока филактерия на одном с вами плане существования вы получаете +10 маны, а также вы можете возможность поддерживать жизнь одного призванного или воскрешённого существа не трятя ману(Фактически, его жизнь поддерживает филактерия) и получаете 50% сопротивления некр. энергии.
...
- Вы можете начать 12-часовую медитацию, чтобы получить 1 редкое заклинание на ваш выбор. Количество заклинаний, полученных таким образом не может превышать вашу МДР.
...
- Вы теряете 6 маны, но взамен получаете +1КД и +2 к атакам в дикой форме.
...
- Вы получаете +БМ к СКР на 2 хода за каждое использованное заклятие иллюзии.
...
- Вы получаете БМ очков божественного знания. Вы можете использовать Божественное Знание, чтобы уменьшить на РЕЛ сложность используемых заклинаний, увеличить на РЕЛ КМЗ или увеличить на РЕЛ проверку одного из следующих навыков: Анализ, История, Магия, Природа, Медицина. Божественное знание срабатывает ровно на 1 проверку. Потраченные очки Божественного Знания полностью восстанавливаются после короткого отдыха. 
...
- Когда вы наносите урон нежити или исчадиям, то можете не бросать кубики, а вместо этого нанести максимальный урон. ХАР раз в день.
...
- Вы чувствуете близость противника к смерти. Если у противника менее 25% хитов, то вы и ваши миньоны наносите x1.5 урон по нему. Если у него менее 10% хитов, то вы или ваши миньоны могут прикосновением мгновенно убить его, восстановив вам 3 маны. Тратит действие.
...
- Вы можете войти в безумие на 3 хода. В таком состоянии вы получаете сопротивление любому урону и в свой ход используете случайные заклятия в случайные цели поблизости. Вы не тратите ману, получаете -5 к сложности заклинаний, а также используете негативные заклинания только на противников, а позитивные - только на союзников. 3 хода, 1 раз в день.
- Если заклинание имеет длительность более одного хода, то вы можете продлить его на 1к4-2 ходов. 
- Вы получаете заклинание *Безумие*. Вы можете 1 раз использовать его без траты маны. Перезарядка - короткий отдых.
...
- Вы получаете дополнительную 5 маны.
...
- Количество маны повышается на 5.
...
- Вы получаете дополнительные 5 маны.
...
- Вы можете потратить 5 маны, чтобы получить преимущество на проверку Обмана, Убеждения или Запугивания против избранного врага. Если проверка была успешной, то вы исцелитесь на половину значения урона от божественной кары.
...
- Вы можете использовать больше маны и получить несколько преимуществ для одной и той же проверки.
- Вы получаете +5 маны.
...
- Вы получаете +1 КМЗ.
- На время действия сопровождения вы дополнительно получаете +2КД и +1КМЗ.
- Вы получаете +5 маны.
...
- Плутовское чутьё позволяет перебрасывать с преимуществом. Также, плутовское чутьё позволяет перебросить все кости урона, если вы атаковали с использованием скрытой атаки. Вы получаете БМ дополнительных использования плутовского чутья.
...
- Вы становитесь полузаклинателем(ИНТ). Вы получаете заклинание "Волшебная рука" и ещё 2 необычных заклятия.
- Вы можете выбрать до 2ух заговоров из раздела "прочее".
...
- При сборе ресурсов вам в 2 раза чаще попадаются яды и модификаторы. Если вы нашли ядовитое растение, то получаете в 2 раза больше ингридиентов.
...
- Вы можете растолочь и высушить любой алхимический ингридент, чтобы получить из него алхимическую пыль. Вы можете бонусным действием распылить её в союзника или в противника(20ф), чтобы вызвать следующий эффект:
  ...
  - Пыль из зелья - +2КМЗ и +1 на след. атаку заклинанием
...
- Вы становитесь полузаклинателем(МДР). Вы можете выбрать 1 редкое и 2 необычных заклинания Созидания или Иллюзии.
- Вы получаете -2 к сложности заклинаний Иллюзии и Созидания, а также один раз в день бонусным действием можете использовать случайное из изученных заклинаний на близжайшую подходящую цель. Использованное заклинание не тратит маны. Если это было заклинание Созидания или Иллюзии, то оно автоматически успешно.
...
- Вы становитесь полузаклинателем(МДР). Вы получаете Шаг теней и ещё 2 любых необычных заклинания.
- Шаг теней не тратит маны.
...
- Вы можете потратить 5 маны, чтобы вырастить чешую дракона. Вы получаете неуязвимость к урону дракона-предка и сопротивление физическому урону. Если вы наносите урон, совпадающий с стихией дракона-предка, то урон удваивается. 3 хода, 1 раз в день.
...
- Раз в день вы можете использовать баффающее заклятие 1ого уровня без траты маны.
- Вы получаете 1 редкое и 1 необычное заклинание возвышения.
...
- При атаке заклинанием из засады КМЗ противника уменьшается на вашу МДР. Спасбросок не может быть меньше нуля.
...
- Вы можете создать телепатическую связь с существом, которое вы видите. Связь существует 1 час и разрывается, если вы оказываетесь на разных материальных планах. Вы можете телепатически разговаривать с этим существом, а также видеть всё, что он видит, если он разрешит. МДР раз в день

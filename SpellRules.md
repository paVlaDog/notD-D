...
- Некоторые классы являются полузаклинателями. Количество маны для них - МОД * УР / 5 + МДР * 3, Количество извечтных заклятий - УР/2 + ИНТ. Полузаклинатели не могут использовать заговоры.  

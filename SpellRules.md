...
- МОД - ваша основаня характеристика (для классов-заклинателей).

### Правила заклинаний:

- Заклинания делятся на 2 типа - заговоры и заклятия.
- Заговоры - заклинания нулевого уровня. Их можно использовать без ограничений.
- Заклятия - заклинания 1 и выше уровней. На них придётся тратить ману.
- Количество известных заклятий для немагических классов - ИНТ. Для магических классов чаще всего УР + ИНТ * 2, если в способностя класса не указано иное.
- Количество известных загоров для магических классов - УР/2 + ИНТ (с округл. вверх). Немагические классы и паладины не могут использовать заговоры, если прямо не указано иное. 
- Со старта вы можете выбрать себе заклинания с распространённость "Обычное" или "Необычное" в количестве максимума известных заклинаний данного типа.
...
- Попадание заклинанием по противникам: КМЗ + спас. ЛОВ цели, если можно уклониться VS Сила заклинания.
- Стартовый КМЗ(класс магической защиты): МДР + особые бонусы.
- На сотворение заклинаний требует мана. Для заклинаний 1ого уровня - 3, 2ого - 6, 3его - 10, 4ого - 18, 5ого - 30, 6ого - 50.
- Большинство магических классов имеют запас маны равный МОД * УР/2 + МДР * 3. 
- Некоторые классы являются полузаклинателями. Количество маны для них - МОД * УР / 5 + МДР * 3, Количество известных заклятий - УР/2 + ИНТ. Полузаклинатели не могут использовать заговоры. Полузаклинатели могут кастовать заклинания второго круга с 8ого уровня и третьего с 16.  
- Немагические классы имеют запас маны равный МДР * 3. Немагические классы могут использовать только заклинания 1ого уровня.
...
- При мультиклассировании во всех формулах не складываются бонусы к известным заклинания от ИНТ и к мане от МДР.

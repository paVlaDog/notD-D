...
*Ярость* - Вы можете бонусным действие войти в состяние ярости. В ярости вы получаете преимущество на проверки и спасброски силы, бонус к атакам и урону, но не можете использовать заклинания. Длительность ярости - 3 хода. Также ярость даёт +10МС и +1КД, если вы без доспехов.  
...
*Безрассудная атака* - Перед атакой вы можете решить атакаовать безрассудно. Вы получаете преимущество на атаку и +5% шанс крита(достаточно выкинуть 19), 
но все атаки по вам будут с преимуществом.  
...
*Тактика* - Вы можете использовать Рывок и Отход бонусным действием.  
...
### Архетипы воина:
- **Мастер боевых искусств.** Мастер боевых искусств посвящает себя изучению различных приёмов, позволяющих им стать величайшими мастерами фехтования, способными играюче обезоружить любого.  
...
*Божественный канал* - При использовании заклинания вы можете использовать божественный канал, чтобы усилить !заклинание!.  
...
БМ раз, перезарядка - короткий отдых.  

*Божественное вмешательство* - В сложной ситуации вы можете попросить божество о помощи. Опишите, что вы хотите от божества и киньте на религию. Мастер решает, станет ли вам помогать божество и характер этой помощи. Также, это умение даёт вам дополнительные ячейки заклинаний 1ого уровня.  
Кол-во ячеек: 1/2/3/4/5/6
...
*Аура паладина* - Вы можете выбрать 1 ауру. Ауры действуют в сфере радиусом 35футов.  
...
*Компетентность* - Выберите 2 навыка. Ваш бонус мастерства для этих навыков удваивается. Вы можете перекинуть неудачную проверку характеристики или атаку. БМ раз в день.

*Скрытая атака* - Если вы атакуете лёгким оружием с преимуществом или по цели, которая сражается с вашим союзником, то вы наносите дополнительный урон. 
Кинжалы наносят 1к6 урона.  
Доп. урон: 1к6/1к8/2к4/1к10/1к12/2к6  

*Незаметность* - Вы можете использовать засаду бонусным действием.

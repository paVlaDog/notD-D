...
!заклинание! - только заклинание. Заговоры не подойдут.  
...
1к8 - Кость хитов.   
Владение простым оружием, лёгкими доспехами, стрелковым оружием, фехтовальным оружием, лёгкими доспехами и музыкальными инструментами.   
...
Кости вдохновения: 1к4/1к6/1к6/1к8/1к10/1к10  
Кол-во костей: БМ/БМ/БМ+1/БМ+1/БМ+1/БМ+3  

*Песнь отдыха* - На коротком отдыхе бард может сыграть песнь отдыха. Союзники восстановят дополнительные хиты и получат бонус к любой характеристике до конца дня. Бард получает удвоенный бонус. Бонусы к характеристике не складываются. Также, если у вас есть особые музыкальные произведения, то союзники получат бонус от них.
Восстановление хитов: 1к6/1к10/2к6/2к8/2к12/2к20  
Прибавка характеристик: 1/1/2/2/3/3  

### Коллегии бардов:
- **Коллегия доблести.** Барды коллегии доблести сопровождают героев в их приключениях, помогаю им в сражениях и позднее складывая баллады об их подвигах.  
- **Коллегия очарования.** Барды этой коллегии очаровывают слушателей своими песнями и создают прекрасные песни о любви. Ходят слухи о связи Коллегии очарования с Царством фей.  
- **Коллегия святости.** Коллегия святости сочиняет мессы для храмов и часто барды этой коллегии являются жрецами каких-либо богов. Их главная цель - помощь в уничтожении зла.  
...
- **Коллегия знаний.** Барды коллегии знаний пытаются собрать любые древние знания, отстраивая огромные библиотеки и отправляются в приключения, дабы найти и сохранить артефакты давно минувших дней.  
- **Коллегия шёпотов.** Таинственная коллегия, ненавидимая и презираемая всеми остальными бардами. Они маскируются под представителей других коллегий, и, прикрываясь их добрым именем, обворовывают и шантажируют богатых людей. Каждый член этой коллегии считает себя Робином Гудом, ворующим у богатых и помогающим бедным, то есть себе и своей коллегии.  
...
*Ярость* - Вы можете бонусным действие войти в состяние ярости. В ярости вы получаете преимущество на проверки и спасброски силы, бонус к атакам и урону, но не можете использовать заклинания. Длительность ярости - 5 ходов. Также ярость даёт +10МС и +1КД, если вы без доспехов.  
Кол-во использований: БМ.  
Доп атака: 2/3/4/5/6/7  
Доп урон: 2/3/4/6/8/10  

*Защита без доспехов* - Ваш КД без доспехов равен 10+ЛОВ+ТЕЛ.  

*Безрассудная атака* - Перед атакой вы можете решить атакаовать безрассудно. Вы получаете преимущество на атаку и +5% шанс крита(достаточно выкинуть 19), но все атаки по вам будут с преимуществом.  

### Пути варвара:
- **Путь безграничной ярости.** Варвары этого пути умеют использовать свою ярость лучше других, становясь неостановимыми машинами для убийств.  
- **Путь фанатика.** Варвары-фанатики - ярые последователи своих богов, готовые убить любого, кто не разделяет веру их повелителя. Забавно, что они даже не всегда знают, за кого они сражаются.  
...
- **Путь духа-предка.** Некоторые варвары могут неосознанно призывать духов своих предков, получая от них помощь и покровительство.  
...
- **Путь дикой магии.** Порою варвары могут неосознанно управлять потоками магии, выплёскивая её на врагов во время своей ярости. Варвары этого пути учатся чаще вызывать подобные всплески энергии.  
...
*Манёвры* - Во время боя вы можете использовать очки манёвров(ман), чтобы сделать манёвры. Можно выбирать только из списка известных манёвров. Очки манёвров полностью восстанавливаются после длительного отдыха.  
Количество известных манёвров: 3/4/5/6/7/8
Количество очков манёвра: 5/6/7/8/9/10 
	...
	* Обезоруживание - 1ман, при атаке, при попадании проверка Ловкость рук против Ловкость рук, при успехе противник теряет оружие. 
	...
	* Финт - 1ман, при атаке, противник получает -3 КД против данной атаки (Не ниже 10).
	...
	* Удар плечом - 1ман, бонусное действие, проверка Атлетики против Атлетики, при провале противник падает ничком.
	...
	* Ложный удар - 2ман, при первой атаке, независимо от результата первой атаки, вы получаете +6 к второй атаке в этом ходу.
...
*Боевой стиль* - Вы можете выбрать боевые стили. Количество стилей: 1/2/3/4/5/6.  
    ...
    * Оборона - +1 к КД щитов и доспехов.  
...
- **Чемпион.** Чемпионам не нужны хитрые приёмы и сложные тактики. Чемпиону достаточно одного точного удара, чтобы разрубить противника пополам или превратить ему голову в кровавую кашу.  
...
*Дикая форма* - Вы можете действием превратиться в зверя, которого вы недавно видели. Вы получаете его характеристики. Вы можете действием в любой момент вернуться в форму друида. Если в форме зверя вы потеряли последнюю единицу здоровья, то вы превращаетесь в друида и получаете остаток урона. Инициатива при превращении не меняется. Нельзя использовать заклинания в форме зверя. Вы не можете превращаться в плавающего и летающего зверя до достижения определённого уровня. БМ раз в день.  
Макс ПО зверя, в которого можно превратиться: 0.25/0.5/1/1/2/4  
Способ передвижения зверя: Только сухопутный/Может плавать/Может плавать/Может плавать или летать/Может плавать и летать/Может плавать и летать  
...
### Круги друидов:
- **Круг полумесяца.** Круг полумесяца - самый известный среди других народов и самый дружелюбный круг, специализируется на рекрутировании новых друидов и следопытов, 
расширяя армии защитников природы. Почти все непотомственные друиды когда-то состояли в этом кругу. Также он сильнее всего занимается политикой, иногда даже закрывая глаза на вырубку лесов.  
...
- **Круг полнолуния.** Друиды круга полнолуния живут далеко в чащах, сильнее всего соединяясь с природой и пробуждая в себе зверя. Они отшельники, лишь редко собирающиеся, чтобы обменяться информацией, и почти не видящие мир, за границами лесов.  
...
### ЖРЕЦ:
1к8 - Кость хитов.  
Владение простым оружием, лёгкими и средними доспехами, цепом и молотом.  
...
Также, при использовании !заклинания! вы можете использовать божественный канал, чтобы усилить !заклинание!. БМ раз, перезарядка - короткий отдых.  
* Если вы поклоняетесь доброму божеству, то заклинание дополнительно похилит цель на РЕЛ.  
* Если вы поклоняетсь нейтральному божеству, то заклинание даст увеличит КД или спасбросок от следующей атаки на РЕЛ.  
* Если вы поклоняетесь злому божеству, то заклинание нанесёт дополнительные РЕЛ урона некротической энергией.     
...
**Примеры молитв:**  
	...
	Домен смерти:
		Боже, воскреси его! - Ваш бог помогает с воскрешением
		Боже, не дай мне умереть! - Ваш бог даёт вам бафы против смерти
		Боже, упокой их! - Ваш бог уничтожает нежить
...
*Предмет договора* - Вы получаете предмет, который дарует вам ваш покровитель. Предмет договора является магической фокусировкой.  
	...
	* Договор гримуара - Вы получаете гримуар. Ваш повелитель вписывает вам в грумуар заклинания и заговоры, которые считаются для вас известными и не учитываются при подсчёте известных заклинаний и заговоров. Также в книге появляется тайная страница с заклинаниями, которые вы можете творить без ограничений. Если вы потеряли гримуар, то вы можете получить новый, попросив его у повелителя четырёхчасовым риталом.  
    Кол-во доп. заговоров: 2/2/3/3/3/4  
    Кол-во доп. заклинаний: 1/2/3/4/5/6  
    Кол-во заклинаний на тайной странице: 0/0/1/1/2/3  
	...
	* Договор цепи - Вы можете потратить 4 часа, чтобы получить фамильяра от своего повелителя. Это может быть кошка, ворон, крыса, летучая мышь, паук, куница, змея, сова, ястреб. Фамильяр ходит в ваш ход и полностью подчиняется вашим командам. Он получает бонусы к КД, броскам атаки и урону. При получении происхождения, вы можете выбрать новые типы фамильяров.  
    Бонус к КД: 1/2/2/3/3/4  
    Бонус к атаке: 0/1/2/4/6/8  
    Бонус к урону: 2/3/4/6/8/10  
...
Вы можете выбрать 2/3/4/5/6/7 воззваний.  
	...
	- Колдовская броня - Доспехи мага считаются заговором и не расходуют драг. камни.
	...
	- Чувствующий магию - Вы можете использовать исследование магии как заговор.
	...
	- Гробница Левитуса(Ур > 3) - Перед получением урона вы можете заковать себя в лёд на 1 ход. Вы получаете 5*УР временных хитов, не можете передвигаться и недееспособны. 1 раз в день.
	...
	- Ответный удар(Договор талисмана)(Ур > 11) - Если по носителю талисмана попали атакой, то вы можете потратить один заряд, чтобы реакцией использовать !заклинание! на атаковавшего.
...
*Обет и аура* - Вы можете выбрать 1 ауру. Ауры действуют в сфере радиусом 35футов.  
	...
	Аура ненависти - Все противники в ауре получают ХАР урона в начале каждого вашего хода.  
Также, вы выбираете обет паладина. Если вы будет соблюдать его до прокачивания клятвы на новый уровень, то получите дополнительное умение клятвы. **Обеты:**
...
- **Клятва мести.** Красные рыцари - свидетели ужасных событий, клянутся уничтожать зло без сожаления и пощады, где бы они не были. Никто не смеет вставать на их пути, а если посмеет - значит он тоже союзник зла, и его надо уничтожить.
...
*Плутовские навыки* - Вы получаете очки навыков. За них вы можете прокачать любой навык, владение, спасбросок, или получить компетентность на любой изученный навык.  
Количество очков навыков: 2/3/4/5/6/7

*Скрытая атака* - Если вы атакуете лёгким оружием по цели, которая вас не видит или сражается с вашим союзником, то вы наносите дополнительный урон.
...
### Профессии плута:
- **Вор.** Вор - не самая благородная профессия, но зато очень романтичная и крайне прибыльная. Карманники, мошенники и шантажёры есть почти везде, а многим искателям приключений нужны опытные взломщики, поэтому они готовы закрыть глаза на преступное прошлое своих товарищей, хоть и всегда следят за их действиями, чтобы не проснуться в одну прекрасную ночь без вещей и денег.
...
- **Шпион.** Шпионы - профессионалы в слежке и обмане, способные притвориться другим человеком, подражая его голосу и подделывая его подчерк. Всего один шпион способен перевернуть ход истории, выкрав важные свдения или подделав приказы и заведя вражеские армии в ловушку. Хорошие шпионы на вес золота, и они смогут найти работу почти в любой сфере, если захотят.
- **Дуэлянт.** Дуэлянты воспринимают дуэль как искусство, пытаясь сделать не эффективо, а красиво. Придержаваясь извращенного кодекса чести, они часто становятся пиратами, гладиаторами или профессиональными дуэлянтами, сражающимися в подпольных боях за интересы своих повелителей.
...
*Метка охотника* - Бонусным действием вы можете наложить на противника метку охотника. Вы получаете +МДР к броскам атаки и урона по этой цели, а также преимущество на выслеживание. Метка действует 1 день. МДР раз в день.
...
- **Убийца монстров.** Некоторые следопыты посвящают себя охоте, но не на скучных обитателей лесов и лугов, а на жутких монстров, собирая трофеи и продавая их или обвешивая ими себя.
...
**Способы использования метамагии:** (МЕТ = единица метамагии)
    ...
    * Непреодолимое заклинание - Потратить 3 МЕТ, чтобы противник снизить спасбросок противника на 10 (Не может опуститься ниже нуля, только на эту атаку).
    ...
    * Продлённое заклинание - Потратить 4 МЕТ, чтобы удвоить длительность заклинания.
...
- **Теневая магия.** Чародей может быть связан не только с прекрасным фейским миром, но и с царством теней. В таком случае, его магия иллюзии становится сильнее, ведь она связана с этим царством.
...
| Уровень мага  | Известные Заговоры | Известные Заклинания  | 1 | 2 | 3 | 4 | 5 | 6 | 7 | 8 | 9 | 
| -- | -- | -- | - | - | - | - | - | - | - | - | - | 
...
| 16 | 7  | 18 | 7 | 4 | 3 | 2 | 1 | 1 | 0 | 0 | 0 | 
| 17 | 7  | 19 | 7 | 4 | 3 | 2 | 1 | 1 | 1 | 0 | 0 | 
...
| Уровень мага  | Известные Заклинания | Количество ячеек | Уровень ячеек | Дополнительные ячейки |
| --- | --- | --- | --- | ----- |
| 1   | 2   | 2   | 1   |       |
| 2   | 3   | 2   | 1   |       |
| 3   | 3   | 3   | 1   |       |

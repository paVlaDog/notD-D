...
Дополнительные способности:
  ...
  - **Боевой раж** - Вы получаете +2 к атаке и урону в ближнем бою в начале ярости и +1к4 к урону в ближнем бою за каждые 2 хода в ярости. Этот урон увеличивается крит. ударом. Бонус к урону срабатывает не более чем на 1 атаку в ход.
...
Восстановленные ячейки(количество^уровень ячейки): 1^1/2^1/2^1/2^2/3^2/3^3
...
* Если вы поклоняетсь нейтральному божеству, то заклятие увеличит КД или спасбросок от следующей атаки на РЕЛ.  
...
*Использование заклинаний*(ХАР). (Фокусировка - предмет договора/стандартная фокусировка)
